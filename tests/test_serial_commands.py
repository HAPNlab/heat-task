...
class TestSetTcuStateCommand:
    def test_rest_mode(self):
        expected = [0xAA, 0x0, 0xA, 0x29, 0x0, 0x0, 0x5, 0xC1, 0x0, 0x2, 0x1]
...
class TestRunTestCommand:
    def test_reset_clock_true(self):
        expected = [0xF, 0x0, 0x9, 0x16, 0x0, 0x0, 0xA, 0x0, 0x0, 0x1]
...
class TestFiniteRampByTimeCommand:
    def test_encoding(self):
        expected = [
            ...
            0xC, 0x80, 0x0, 0x0, 0x0, 0x64, 0x80, 0x0, 0x0,
        ]
...
class TestSimulateResponseUnitCommand:
    def test_encoding(self):
        expected = [0x70, 0x0, 0x9, 0x2D, 0x0, 0x0, 0x48, 0x89, 0x0, 0x0]
